    	...
    	<div class="container"><!-- container -->
            ...
            <div class="row no-gutter"><!-- row -->
                ...
                <div class="col-lg-8 col-md-8"><!-- doc body wrapper -->
                    	...
                    	<div class="row gutter"><!-- row -->
                        	...
                        	<div class="col-lg-12 col-md-12">
                               <figure class="news-featured-image">    
                            	...
                            	<h1 class="page-title">Manajemen :</h1><!-- category title -->
										Komisaris : Hj. MAIKEM<br>
										Direktur Utama: H. JASMANI<br>
										Direktur : H. SUKARNO<br>
                            </div>
                    ...
                    <h1 class="page-title">Staff :</h1><!-- category title -->
						Direktur Marketing : M. Syahril <br>
						Bussiness & Development Sarjana : Yudy Mulyawan
						Personalia : Andreas
						Juju Supriyanto Produksi & Pemasaran
                    ...
                    <div class="col-padded col-shaded"><!-- inner custom column -->
                        ...
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                            ...
                            <li class="widget-container widget_nav_menu"><!-- widget -->
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url('project/harga');?>" title="menu item">Daftar Harga</a></li>
